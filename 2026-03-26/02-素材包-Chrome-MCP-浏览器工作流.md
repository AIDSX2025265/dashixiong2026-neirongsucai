...
## 原帖图片 / 视频
- https://pbs.twimg.com/media/HETSITdbYAEM4hq.jpg

## 原帖/配图中提取出的落地链接
- 当前这轮采集结果里，正文和图片未直接带出可见明链

## 评论区补充素材
### 补充信息
- 这 mcp 操作的时候慢得要死
- 可以用当前自己账号的 profile 么？
- Chrome DevTools MCP
- 调试用 chrome mcp，模拟用户操作用 agent-browser（更轻量）
